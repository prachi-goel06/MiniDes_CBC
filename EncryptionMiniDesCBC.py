...
# Stream of data to be encrypted
    ...
    for i in range(0, len(blocks)):
        ...
        print("IV is for block ",i+1,": '",binary_iv)
        blocks[i] = encryption.XOR_IV_Block(binary_iv, blocks[i])
        ...
        binary_iv = (Encrypted_message_Ri + R)
        print("'Encryption of block",i+1,"given by RiLi: '", binary_iv, '\n\n\n')
        ciphertext+=binary_iv
